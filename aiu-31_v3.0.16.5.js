...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (has('[data-highlight-text]')) initHighlightText(); //scrolltrigger

  if (has('[data-faq-item]')) initFAQ();
  if (has('[data-faq-tabs]')) initFAQWraps();
  if (has('[data-tabs-wrap]')) initHelpCenter();

  if (has('[data-counter]')) initCounters();  //scrolltrigger
  ...
  if (has('[data-scroll-into-view-first]')) initScrollIntoViewFirst(); //scrolltrigger
  if (has('[data-scroll-into-view-second]')) initScrollIntoViewSecond(); //scrolltrigger
  if (has('[data-fade-in-on-scroll]')) initFadeInOnScroll(); //scrolltrigger
